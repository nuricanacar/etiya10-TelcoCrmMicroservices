...
//            throw new BusinessException("Individual Customer with identity number " + nationalId + " already exists");
//        }
//    }

    public void checkIfIndividualCustomerExistsByIdentityNumber(String nationalId) {
        if (individualCustomerRepository.existsByNationalId(nationalId)) {
            throw new BusinessException(localizationService.getMessage(Messages.NationalityIdentityExists)); //artık dile göre properties bulup mesajı dönecek
        }
    }
}